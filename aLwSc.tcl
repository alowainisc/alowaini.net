...
#                                                   |_|          #
# 	# Script Name        : aLwSc.tcl    	                 #
#	# Script Version     : aL(w)Sc	                 	 #
#  	# Author             : F4R1S       			 #
# 	# Release Date       : 16 Agustus 2026		         #
  ...
  foreach chan [channels] {
    if {[onchan $botnick $chan]} {
      if {[botisop $chan]==1} {
        ...
        # Hilangkan # dari nama channel
        set channame [string trimleft $chan "#"]

        set Mode "[rw]@$channame"
#        putserv "MODE $chan +b-o+o+n+t-b $Mode $botnick $botnick $Mode"
        putserv "MODE $chan -vok+ov $botnick $botnick $Mode $botnick $botnick"
      }
    }
  }
...
"Zzz..ZZz.." "Online" "Owned by F4R1S" "Lagi Santai" "Ngopi Dulu" "Lagi Mikir" "Jangan Ganggu" "Sedang Sibuk" "Lagi Keluar" "OTW" "Dalam Perjalanan" "Lagi Rebahan" "Nonton TV" "Dengerin Musik" "Main Game"
"Lagi Coding" "Lagi Ngoding" "Maintenance" "Cek Server" "Lagi Tidur" "Mimpi Indah" "Bangun Sebentar" "Mandi Dulu" "Lagi Makan" "Cari Makanan" "Masak Dulu" "Bikin Kopi" "Lagi Belajar" "Fokus Dulu" "Jangan Spam" "Please Wait..."
"BRB" "AFK" "Be Right Back" "Back Soon" "Away for a while" "Busy Mode" "Do Not Disturb" "Invisible Mode" "Stealth Mode" "Loading..." "Connecting..." "Reconnecting..." "System Idle" "Antara Ada dan Tiada" "Sedang Menghilang" "Hilang Sebentar"
"Jangan Dicari" "Cari Aku Nanti" "Nanti Balik Lagi" "Tunggu Sebentar" "Lagi Menyendiri" "Lagi Galau" "Lagi Bahagia" "Lagi Santuy" "Mode Hemat Energi" "Battery Low" "Low Power Mode" "Power Nap" "Keep Calm" "Stay Cool" "Enjoy Life" "Have Fun"
"Always Watching" "Watching You" "Target Locked" "Mission Active"
}
set rms {
...
proc make_notc {} {
  ...
  set nick [string tolower $botnick]
  ...
  foreach c [split $nick ""] {
    ...
    if {[expr $i % 2] == 1} {
      ...
      append result "04[string toupper $c]"
...
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "m\l\gn"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "AmX.z1TVVuV.MsDHv1cjsdY.ctmKQ.Oy.Va0EJ5Hm1n.K.N1"]"]
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "m\l\gw"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "AmX.z1TVVuV.MsDHv1cjsdY.ctmKQ.Oy.Va0EJ5Hm1n.K.N1"]"]
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "m\l\gx"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "AmX.z1TVVuV.MsDHv1cjsdY.ctmKQ.Oy.Va0EJ5Hm1n.K.N1"]"]
[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ev\i\m"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "Y7PMW0CFqbL0xFNna/qp81f/xKoLH.n0E4D."]"]
...
proc pub_resync {nick uhost hand channel rest} {
  ...
  set rmsg [lindex $rms [rand [llength $rms]]]
#  if {![string match "*k*" [getchanmode $channel]]} { putserv "mode $channel -vok+ov $botnick $botnick $rmsg $botnick $botnick" } { putserv "mode $channel -o+o $botnick $botnick" }
#  if {![string match "*k*" [getchanmode $channel]]} { putserv "mode $channel +b-o+o+n+t-b $rmsg@[string trimleft $channel "#"] $botnick $botnick $rmsg@[string trimleft $channel "#"]" } { putserv "mode $channel -o+o $botnick $botnick" }
  if {![string match "*k*" [getchanmode $channel]]} { putserv "mode $channel -vok+ov $botnick $botnick $rmsg@[string trimleft $channel "#"] $botnick $botnick" } { putserv "mode $channel -o+o $botnick $botnick" }
}
...
proc remain {} {
  ...
  if {[getuser "config" XTRA "ODON"]!=""} { set awban $awaybanner } { set awban [lgrnd] }
   if {[getuser "config" XTRA "AWAY"]!=""} { set longer "$awban $vern 0414U04p14T04i14me14:14$awayoutput04 04\[14[getuser "config" XTRA "AWAY"]04\]"
  } { set awaymsg [lindex $awaym [rand [llength $awaym]]] ; set longer "$awban $vern 1404U14pTime:14$awayoutput14 14\[4$awaymsg14\]" }
}
#  if {[getuser "config" XTRA "AWAY"]!=""} { set longer "$awban 04\[14o14nLine:14$awayoutput14\] 14\[4[getuser "config" XTRA "AWAY"]14\]" 
...
#if {$idxc == 1} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "zi9Bj/KmHX8.WVDCA/UeXmU0edoNX.9Z1jz/8PN5m1thb.60"]"]
#} elseif {$idxc == 2} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "MwkVF0Ag/r9.rJRtI.AdGAM0edoNX.9Z1jz/FFakT1TKKVj."]"]
#} elseif {$idxc == 3} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "zzt6Q1yX0QJ.taQHV0oyk7f.edoNX.9Z1jz/R4d8j1cQ1VZ."]"]
#} elseif {$idxc == 4} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "5CL41.RkV3l/CtsGl/5PU1Z1edoNX.9Z1jz/3yzxE.8MEwA0"]"]
#} elseif {$idxc == 5} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "7Htr9.BZIUf.nGlGF/EAcDz0edoNX.9Z1jz/1JsLj.u2LcN0"]"]
#} elseif {$idxc == 6} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "lZhhs1/h2en.Hn4.b0Ya144.edoNX.9Z1jz/QraXO1X/1/A/"]"]
#} elseif {$idxc == 7} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "aocae1hjx.M.sFvKI0Hx5ea.vkDy71bP1rA/5NH0P1jxm1F1z537p.5WYmm."]"]
#} elseif {$idxc == 8} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "fQORQ1.cwVE/xgsrG1dtRPD1vkDy71bP1rA/QmbDJ1udgoh1z537p.5WYmm."]"]
#} elseif {$idxc == 9} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wfk6c1CJPL.16aK7q/u2WaI0Q6X3w1xryM90xxXOI/bRkNu0"]"]
#} elseif {$idxc == 10} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] ".PPrX.Qpqof.6aK7q/u2WaI08daZ21o9XXj0xxXOI/bRkNu0"]"]
#} elseif {$idxc == 11} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "aufa6//fiz606aK7q/u2WaI0XqBH40UEU.z.xxXOI/bRkNu0"]"]
#} elseif {$idxc == 12} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ulwsy/9BeX306aK7q/u2WaI0s6q2B.T83lf1xxXOI/bRkNu0"]"]
#} elseif {$idxc == 13} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "tbJbe/BuWLW/ZQdqU11h1UN.ijZiG/3j752/FucmV0eSDSV."]"]
#} elseif {$idxc == 14} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "tbJbe/BuWLW/SCYtP/jHGGy/5U2WZ/aHi940FucmV0eSDSV."]"]
#} elseif {$idxc == 15} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "tbJbe/BuWLW/6aK7q/u2WaI0eVaAY0Ss0DK.xxXOI/bRkNu0"]"]
#} elseif {$idxc == 16} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "qz8c7.xe7QT/OnnJ.0grrYd/vwlMC.9A1qa/KxP611pJIOu1"]"]
#} elseif {$idxc == 17} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "zi9Bj/KmHX8.WVDCA/UeXmU0edoNX.9Z1jz/8PN5m1thb.60"]"]
#} elseif {$idxc == 18} {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "MwkVF0Ag/r9.rJRtI.AdGAM0edoNX.9Z1jz/FFakT1TKKVj."]"]
...
#} else {
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "r\w\c\x"] 0
#[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "hv\g"] [[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "ot\i\m\w"] [[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "wvar\k"] "[[dezip [dcp "qpuNu12372Z.rpvtO0s7VP0."]] "gnl6m0.GFXp0/0Ogn/SofCy1JSPUF.QFhx61KDABO.N37QS."]"]
#}
#}
set lgidx 0
proc lgrnd {} {
  global lgidx botnick
  set lgidx [incr lgidx]
  set nick [string tolower $botnick]
  set lgrnd ""
  set i 0

  set colors {1 2 3 4 5 6 7 10 12}
  set color [lindex $colors [expr ($lgidx - 1) % [llength $colors]]]
  ...
  foreach c [split $nick ""] {
    ...
    if {[expr $i % 2] == 1} {
      ...
      append lgrnd "${color}[string toupper $c]"
    }
  }
...
proc chk_five {min h d m y} { global longer ; set autoaway [getuser "config" XTRA "AUTOAWAY"] ; if {$autoaway == "ON"} { catch { remain } ; puthlp "AWAY :$longer" } ; auto_ping "0" "0" "0" "0" "0" }

## +/- autoaway
bind pub n `+autoaway pub_+autoaway
proc pub_+autoaway {nick uhost hand channel param} { global notc ; if {![matchattr $nick Q]} { puthlp "NOTICE $nick :$notc 4auth 1st!" ; return 0 } ; set autoaway [getuser "config" XTRA "AUTOAWAY"] ; if {$autoaway == "ON"} { puthlp "NOTICE $nick :$notc AuToAWaY is already 4ON" ; return 0 } ; setuser "config" XTRA "AUTOAWAY" "ON" ; saveuser ; puthlp "NOTICE $nick :$notc AuToAWaY \[4ON\]" ; return 0 }

bind pub n `-autoaway pub_-autoaway
proc pub_-autoaway {nick uhost hand channel param} { global notc ; if {![matchattr $nick Q]} { puthlp "NOTICE $nick :$notc 4auth 1st!" ; return 0 } ; set autoaway [getuser "config" XTRA "AUTOAWAY"] ; if {$autoaway != "ON"} { puthlp "NOTICE $nick :$notc AuToAWaY is already 4OFF" ; return 0 } ; setuser "config" XTRA "AUTOAWAY" "OFF" ; saveuser ; puthlp "AWAY" ; puthlp "NOTICE $nick :$notc AuToAWaY \[4OFF\]" ; return 0 }
